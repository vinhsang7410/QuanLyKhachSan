...
namespace QuanLyKhachSan.DAO
{
    public class KhachHangDAO
    {
        ...
        public KhachHang GetInfoByIdCard(string idCard)
        {
            string query = "USP_IsIdCardExists @idCard";
            KhachHang customer = new KhachHang(DataProvider.Instance.ExecuteQuery(query, new object[] { idCard }).Rows[0]);
            return customer;
        ...
        internal bool InsertCustomer(KhachHang customer)
        {
        ...
        internal bool UpdateCustomer(KhachHang customerNow, KhachHang customerPre)
        {
