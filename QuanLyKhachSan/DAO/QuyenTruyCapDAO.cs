...
{
    class QuyenTruyCapDAO
    {
        #region Properties
        private static QuyenTruyCapDAO instance = new QuyenTruyCapDAO();
        internal static QuyenTruyCapDAO Instance { get => instance; }
        private QuyenTruyCapDAO() { }
        #endregion
