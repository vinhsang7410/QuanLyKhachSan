...
namespace QuanLyKhachSan.DAO
{
    ...
    {
        private static NhanPhongDAO instance;
        private NhanPhongDAO() { }
        ...
        public int GetIdReceiveRoomFromIdRoom(int idRoom)
        {
            ...
            NhanPhong receiveRoom = new NhanPhong(dataTable.Rows[0]);
        ...
        public static NhanPhongDAO Instance
        {
            get { if (instance == null) instance = new NhanPhongDAO(); return instance; }
