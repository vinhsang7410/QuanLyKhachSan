...
namespace QuanLyKhachSan
{
    public partial class frmThemNhanVien : Form
    {
        ...
        {
            bool isFill = frmQuanLyKhachHang.CheckFillInText(new Control[] { txbName, comboBoxStaffType, txbName ,
            ...
            if (isFill)
            {
                try
                {
                    ...
                    accountNow.PassWord = frmQuanLyNhanVien.HassPass;
                    if (TaiKhoanDAO.Instance.InsertAccount(accountNow))
                    {
        ...
        private TaiKhoan GetStaffNow()
        {
            ...
            #region Format
            frmQuanLyNhanVien.Trim(new Bunifu.Framework.UI.BunifuMetroTextbox[] { txbName, txbIDcard, txbAddress });
            #endregion
