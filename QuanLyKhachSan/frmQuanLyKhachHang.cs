...
namespace QuanLyKhachSan
{
    public partial class frmQuanLyKhachHang : Form
    {
        ...
        private void InsertCustomer()
        {
            ...
            try
            {
                KhachHang customer = GetCustomerNow();
                if (KhachHangDAO.Instance.InsertCustomer(customer))
                {
        ...
        private void UpdateCustomer()
        {
            ...
            {
                KhachHang customerPre = groupCustomer.Tag as KhachHang;
                try
                {
                    KhachHang customerNow = GetCustomerNow();
                    ...
                    {
                        bool check = KhachHangDAO.Instance.UpdateCustomer(customerNow, customerPre);
                        if (check)
                        {
        ...
        private void ChangeText(DataGridViewRow row)
        {
            ...
            else
            {
                ...
                KhachHang customer = new KhachHang(((DataRowView)row.DataBoundItem).Row);
        ...
        #region GetData
        private KhachHang GetCustomerNow()
        {
            frmQuanLyNhanVien.Trim(new Bunifu.Framework.UI.BunifuMetroTextbox[] { txbAddress, txbFullName, txbIDCard });
        ...
        {
            return KhachHangDAO.Instance.LoadFullCustomer();
        }
        private DataTable GetFullCustomerType()
        {
            return LoaiKhachHangDAO.Instance.LoadFullCustomerType();
        }

        private DataTable GetSearchCustomer(string @string, int mode)
        {
            return KhachHangDAO.Instance.Search(@string, mode);
        }
