...
namespace QuanLyKhachSan.DTO
{
    public class KhachHang
    {
        ...
        public KhachHang(int id, string idCard, string name, int idcustomerType, string address, int phoneNumber, string sex, string nationality, DateTime dateOfBirth)
        {
            this.Id = id;
            this.IdCard = idCard;
            this.Name = name;
        ...
        public bool Equals(KhachHang customerPre)
        {
            if (customerPre == null)
                return false;
