...
namespace QuanLyKhachSan.DTO
{
    public class TaiKhoan
    {
        ...
        #region Constructor
        public TaiKhoan() { }
        public TaiKhoan(string userName, string displayName, string passWord, int staffType, string idCard, DateTime dateOfBirth, string sex, string address, int phoneNumber, DateTime startDay)
        {
        ...
        #region Method
        public bool Equals(TaiKhoan accountPre)
        {
            if (accountPre == null)
                return false;
